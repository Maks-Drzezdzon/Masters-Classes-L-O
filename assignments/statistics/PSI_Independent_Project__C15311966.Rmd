...
# this is done to check if there is colinearity
dim(tests_matrix)
dim(matrix_data)
...
# its too small to represent the whole dataset
...
df2 = cbind(prepare_matrix_data, dfPCA$x[,1:6])

head(df2)

ggplot(df2, aes(PC1, PC2, PC3, PC4, PC5, PC6, col = SISBEN, fill = SISBEN)) +
