...
# scree plot
# indicates that 2+ should be retained
plot(facsol$values, type = "b")

# Print the components with loadings # look over
psych::print.psych(facsol,cut=0.3, sort=TRUE)

# Print sorted list of loadings # look over
fa.sort(facsol$loading)

# this further supports the analysis derived from the screeplot
# that ~2 components can be extracted
# from those two components its seems only 2 factors have a score of 1
# with most having a factor of 0.7 which could be considered 
fa.diagram(facsol)
