...
scree_dfPCA = prcomp(PCA_data[, -1], center = F)
screeplot(scree_dfPCA)
...
In that sense the model fit is good but not extremely useful as these are somewhat obvious assertions, now with some statistics and graphs to back them up 
