...
```{r Dimension Reduction - heatmap, Bartlett test}
...
A principal component analysis (PCA) was conducted on the 21 items with orthogonal rotation (varimax).  Bartlett’s test of sphericity, Χ2(210) = 102262.6, p< .001, indicated that correlations between items were sufficiently large for PCA.  
