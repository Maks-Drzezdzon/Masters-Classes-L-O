...
# dwdPoly #
###########
dwdPoly = train(Class ~ ., data = train_sample_data, method = "dwdPoly",  trControl=fitControl, tuneLength=20, metric="AUC", scale=TRUE)
...
dwdRadial = train(Class ~ ., data = train_sample_data, method = "dwdRadial", trControl=fitControl, tuneLength=25, metric="AUC", scale=TRUE)
...
dwdLinear = train(Class ~ ., data = train_sample_data, method = "dwdLinear", trControl=fitControl, tuneLength=25, metric="AUC", scale=TRUE)
...
gbmGrid =  expand.grid()
sdwd = train(Class ~ ., data = train_sample_data, method = "sdwd", trControl=fitControl, tuneLength=25, metric="AUC", scale=TRUE)
